            ...
            <div style="font-size: 16px; line-height: 1.5;">
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr>
                        ...
                        <td style="padding: 10px 0; border-bottom: 1px solid #ccc;">{{$formattedCheckInDate}}</td>
                    </tr>
                    <tr>
                        <td style="padding: 10px 0; border-bottom: 1px solid #ccc;"><strong>Check-Out Date:</strong></td>
                        <td style="padding: 10px 0; border-bottom: 1px solid #ccc;">{{$formattedCheckOutDate}}</td>
                    </tr>
                    <tr>
                ...
                <p style="margin-top: 20px; font-weight: bold;">Total Amount Due: ₱{{$totalAmount}}</p>
                <p style="margin-top: 20px;">Payment Method:</strong> {{$paymentModeOnline}}</p>
