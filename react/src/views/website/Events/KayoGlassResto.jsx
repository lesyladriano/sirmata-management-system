...
import one from '/src/assets/images/website/events/kayoglassresto/glass_resto.jpg';
import food from '/src/assets/images/website/events/kayoglassresto/food.jpg';
...
export default function KayoGlassResto() {
  return (
    <div>
      <div className="relative">
        <img
          src="./src/assets/images/website/kayoglassresto.jpg"
          className="w-full h-[400px] object-cover object-center sm:h-full"
          alt=""
        />
        <div className="bg-black/30 p-12 md:p-12 lg:px-16 lg:py-24 absolute inset-0 flex items-center justify-center">
          <h1 className="text-4xl text-white text-center tracking-wide font-[Poppins] sm:text-3xl md:text-5xl">
            KAYO GLASS RESTAURANT
          </h1>
        </div>
      </div>

      {/* Video Section */}
      {/* <section className="bg-gray-200 flex flex-col justify-center items-center py-24">
        <div className="relative w-full">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <button className="bg-white p-4 rounded-lg text-lg font-semibold text-gray-700">
              Play
            </button>
          </div>
        </div>
